...
const AdminCartModal = ({ isOpen, onClose, item }) => {
          ...
          <div className="grid grid-cols-2 lg:grid-cols-10 gap-4 mb-4">
            ...
            <div className="col-span-10 flex items-center justify-start">
              <div className="grid grid-cols-1">
                <p
                  className="font-semibold text-base lg:text-5xl text-start"
                      ...
                      <div className="col-span-1 lg:col-span-4 flex flex-wrap justify-start items-center gap-1">
                        ...
                        {sortedOptions.length > 4 && (
                          <button
                            ...
                            className="mt-2 text-sm flex items-center gap-1 text-[#CB6CE6] hover:text-green-600 transition-colors duration-200"
                          >
